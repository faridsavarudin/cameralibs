...
public class CameraView extends RelativeLayout {
    ...
    LayoutParams textureViewParams;
    ...
    public CameraView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        textureViewParams = new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
    ...
    public void setPositionCenter(){
        if (textureViewParams.getRules().length>0){
            textureViewParams.removeRule(ALIGN_PARENT_TOP);
        }
    ...
    public void setPositionTop(){
        if (textureViewParams.getRules().length>0){
            textureViewParams.removeRule(CENTER_IN_PARENT);
        }
        textureViewParams.addRule(ALIGN_PARENT_TOP);
    }
